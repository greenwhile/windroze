...
public class LabelInfoEuropeArea extends LabelInfo { 
    
    private static final Logger LOGGER;

    static {
        LOGGER = Logger.getLogger(LabelInfoEuropeArea.class.getName());
    }
    ...
    public LabelInfoEuropeArea(int x, int y, String title, String info) {
        ...
        this.height_main = 364;
        this.info_alignement = y_main + 14;
    }
