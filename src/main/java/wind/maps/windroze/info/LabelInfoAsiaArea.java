...
public class LabelInfoAsiaArea extends LabelInfo {

    private static final Logger LOGGER;

    static {
        LOGGER = Logger.getLogger(LabelInfoAsiaArea.class.getName());
    }
    ...
    public LabelInfoAsiaArea(int x, int y, String title, String info) {
        super(x, y, title, info);
        this.width = 470;
        this.height = 50;        
        this.title_alignement = y + 11;        
        this.x_main = x;
        this.y_main = y+height;
        this.width_main = width;
        this.height_main = 360;
        this.info_alignement = y_main + 11;
    }
