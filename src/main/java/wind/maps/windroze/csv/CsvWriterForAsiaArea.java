...
public class CsvWriterForAsiaArea extends CsvWriter {
    
    private static final Logger LOGGER;

    static {
        LOGGER = Logger.getLogger(CsvWriterForAsiaArea.class.getName());
    }

    public CsvWriterForAsiaArea(File file, File binaryFile, double rotation) throws IOException {
    ...
    public void write() {
        ...
        for(double level : distinctLevels){                
            ...
            System.out.println("FROM CSV: " + file.getName());
